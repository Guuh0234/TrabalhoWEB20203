            ...
            <form action="atualizar.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" min="0.00" max="10000.00" 
                            step="0.01"  id="idade" 
                            value="<?php echo $pessoa->getIdade(); ?>"
                            name="idade" placeholder="" required>
                    </div>                            
                    <div class="form-group col-md-6">
                        <label for="Telefone">Telefone</label>
                        <input type="text" class="form-control" id="telefone" 
                            value="<?php echo $pessoa->getTelefone(); ?>"
                ...
                <div class="form-group">
                    ...
                    <input type= "text" class="form-control" id="endereco" 
                           value="<?php echo $pessoa->getEndereco();?>"
                           name=endereco placeholder = "Endereço" required>
                </div>                    
                <div class="form-group">
                <label for="CPF">CPF</label>
                    <input type= "text" class="form-control" id="cpf" 
                           value="<?php echo $pessoa->getCpf();?>"
